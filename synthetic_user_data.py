...
with open("synthetic_user_data.csv", "w", newline="") as csvfile:
    ...
    for user_id in range(1, 1001):
        ...
        product_pref = random_allocation(8, total=100)
        ...
        writer.writerow({
            ...
            "product_preference_stocks": product_pref[0],
            "product_preference_etfs": product_pref[1],
            "product_preference_government_bonds": product_pref[2],
            "product_preference_corporate_bonds": product_pref[3],
            "product_preference_municipal_bonds": product_pref[4],
            "product_preference_savings_bonds": product_pref[5],
            "product_preference_derivatives": product_pref[6],
            "product_preference_alternative_investments": product_pref[7],
